    ...
    return (
        <div>
            <div className="mt-8 md:mt-0 md:px-12">
                <h1 className="mb-6 font-medium text-3xl text-center md:text-start xl:text-5xl">
                    Simplify scheduling <br /> processes for all tasks
                </h1>
                <p className="text-gray-500 text-center md:text-start mt-4">
            ...
            <div className="flex flex-col items-start gap-4 xl:gap-8 md:px-12 mt-6 xl:mt-10">
